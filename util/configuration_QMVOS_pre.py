...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        # Data parameters
        parser.add_argument('--static_root', help='Static training data root', default='/comp_robot/cv_public_dataset/vos_data/static')
        parser.add_argument('--bl_root', help='Blender training data root', default='../BL30K')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/comp_robot/cv_public_dataset/vos_data/YouTube')
        parser.add_argument('--davis_root', help='DAVIS data root', default='/comp_robot/cv_public_dataset/vos_data/DAVIS_2017_trainval')
        ...
        parser.add_argument('--s0_batch_size', default=32, type=int) # 16
        parser.add_argument('--s0_iterations', default=10000, type=int) # 150000
        parser.add_argument('--s0_finetune', default=0, type=int)
        parser.add_argument('--s0_steps', nargs="*", default=[], type=int)
        parser.add_argument('--s0_lr', help='Initial learning rate', default=2e-5, type=float) # 1e-5
        parser.add_argument('--s0_num_ref_frames', default=2, type=int)
        parser.add_argument('--s0_num_frames', default=3, type=int)
        parser.add_argument('--s0_start_warm', default=10000, type=int) # 20000
        parser.add_argument('--s0_end_warm', default=40000, type=int) # 70000
        ...
        parser.add_argument('--s3_batch_size', default=16, type=int) # 8
        parser.add_argument('--s3_iterations', default=60000, type=int) # 100000
        # fine-tune means fewer augmentations to train the sensory memory
        parser.add_argument('--s3_finetune', default=5000, type=int) # 10000
        parser.add_argument('--s3_steps', nargs="*", default=[50000], type=int) # 80000
        parser.add_argument('--s3_lr', help='Initial learning rate', default=2e-5, type=float) # 1e-5
        parser.add_argument('--s3_num_ref_frames', default=3, type=int)
        parser.add_argument('--s3_num_frames', default=8, type=int)
        parser.add_argument('--s3_start_warm', default=10000, type=int) # 20000
        parser.add_argument('--s3_end_warm', default=40000, type=int) # 70000
        ...
        parser.add_argument('--log_image_interval', default=20, type=int)
        parser.add_argument('--save_network_interval', default=10000, type=int) # 25000
        parser.add_argument('--save_checkpoint_interval', default=10000, type=int) # 50000

...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--s0_iterations', default=80000, type=int) # 150000
        ...
        parser.add_argument('--s3_iterations', default=60000, type=int)
        # fine-tune means fewer augmentations to train the sensory memory
        parser.add_argument('--s3_finetune', default=5000, type=int) # 10000
        parser.add_argument('--s3_steps', nargs="*", default=[50000], type=int)
        ...
        parser.add_argument('--s3_end_warm', default=40000, type=int)
        ...
        parser.add_argument('--save_network_interval', default=5000, type=int) # 25000
        parser.add_argument('--save_checkpoint_interval', default=5000, type=int) # 50000
